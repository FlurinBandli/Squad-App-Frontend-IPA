 ...
 * It provides a link to navigate back to the admin squads page.
 * This component is used in the admin section of the application to handle errors gracefully.
 */
